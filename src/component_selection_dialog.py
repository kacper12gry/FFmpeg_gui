...
class ComponentSelectionDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        output_group = QGroupBox("Lokalizacja i nazwa pliku końcowego")
    ...
    def _generate_default_output_name(self):
        ...
        suffixes = {1: "-hardsub", 2: "-remux-hardsub", 3: "-remux", 4: "-intro"}
        suffix = suffixes.get(script_id, "")
        return f"{base_name}{suffix}.mkv"
    ...
    def import_from_txt(self):
        ...
        for i, line in enumerate(lines):
            ...
            # --- KLUCZOWA POPRAWKA: Uodpornienie na brakujące średniki ---
            ...
            elif script_type not in [0, 3]: # Poprawka: skrypt 0 (pusty) jest ok
            ...
            # Konwertujemy stringi na obiekty Path tylko, jeśli nie są puste
            ...
            # Dodajemy `None` dla output_path, bo nie jest obsługiwane w imporcie
